...
function Header() {
  ...
  const aboutText = (
    <Typography sx={{ p: 2 }}>Welcome to Guess The NBA Player, a web application developed by 
    Anthony Bui. I made this for NBA fanatics who are looking to test their player knowledge. 
    Can you name the NBA player based on little information?</Typography>
  );

  const howToPlayText = (
    <Typography sx={{ p: 2 }}>Try and guess the NBA player, and see how high you can score! You get 3 guesses,
     and if you guess correctly then you get +5 points. For each hint you use though, 1 point will be taken away from the potential score. </Typography>
  );
